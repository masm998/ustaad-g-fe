...
export class GoogleMapComponent implements OnInit, AfterViewInit {
  ...
  @Input('createMode') createMode = true
  ...
  private apiKey = `AIzaSyAioMBM9v8-o3WN3Gy5uR9XNRDwreKporo`;
  // AIzaSyDp97Odu-H61CbefJqekN7aL2VHriCGknM
  ...
  icons = {
    aid: 'http://maps.google.com/mapfiles/kml/pal3/icon38.png'
  }
